...
import { GanttTaskItemDrag } from './task-item-drag';
...
@Component({
    selector: 'ngx-gantt-task-bar,gantt-task-bar',
    templateUrl: './task-bar.component.html',
    providers: [GanttTaskItemDrag]
})
export class NgxGanttTaskBarComponent extends GanttItemUpper implements OnInit, AfterViewInit, OnChanges, OnDestroy {
    ...
    constructor(
        ...
        private drag: GanttTaskItemDrag,

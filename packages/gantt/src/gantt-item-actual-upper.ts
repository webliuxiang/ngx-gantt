...
@Directive()
//设置真实计划甘特图
export abstract class GanttItemActualUpper {
    ...
    private setPositions() {
        ...
        itemElement.style.left = this.item.refs.ac_x + 'px';
        itemElement.style.top = this.item.refs.ac_y + 'px';
        itemElement.style.width = this.item.refs.ac_width + 'px';
